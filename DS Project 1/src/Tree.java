...
public class Tree implements Comparable<Tree>{
    ...
    /**
     * Sets src.Tree object's diameter
     *
    ...
    /**
     * Sets src.Tree object's health
     *
     * @param health A String representing src.Tree object's health
     *
    ...
    /**
     * Sets src.Tree object's status
     *
     * @param status A String representing src.Tree object's status
     *
    ...
    /**
     * Sets src.Tree object's species name
     *
     * @param spc_common A String representing src.Tree object's common species name
     *
     * @throws IllegalArgumentException if String spc_common is null
     */
    private void setSpc_common(String spc_common) {
        if (spc_common==null){
            throw new IllegalArgumentException("src.Tree's species type cannot be null");
        }
     ...
     *
     * @param zipcode an integer representing Zipcode of the src.Tree object
     *
     * @throws IllegalArgumentException if int zipcode is negative or more than 5 digits
     */
    private void setZipcode(int zipcode) {
        if (zipcode < 0 || zipcode > 99999){
            throw new IllegalArgumentException("src.Tree has an invalid zipcode.");
        }
        this.zipcode = zipcode;
    }

    /**
     * Sets src.Tree object's borough
     *
     * @param boro A String representing borough where src.Tree object resides
     *
     * @throws IllegalArgumentException if src.Tree object's boroname is not [case insensitive] "Manhattan", "Bronx", "Queens", "Brooklyn",
     * or "Staten Island"
     */
    private void setBoroname(String boro) {
        ...
        throw new IllegalArgumentException("Invalid borough for src.Tree object.");
    }

    /**
     * Gets src.Tree object's ID
     *
     * @return an integer representing src.Tree object's ID
     */
    ...
    /**
     * Gets src.Tree object's diameter size
     *
     * @return an integer representing src.Tree object's diameter
     */
    ...
    /**
     * Gets src.Tree object's zipcode
     *
     * @return an integer representing src.Tree object's zipcode
     */
    ...
    /**
     * Gets src.Tree object's status
     *
     * @return an integer representing src.Tree object's status
     */
    ...
    /**
     * Gets src.Tree object's health
     *
     * @return an integer representing src.Tree object's health
     */
    ...
    /**
     * Gets src.Tree object's borough
     *
     * @return an integer representing src.Tree object's borough location
     */
    ...
    /**
     * Gets src.Tree object's species
     *
     * @return an integer representing src.Tree object's species type
     */
    ...
    /**
     * Gets src.Tree object's x_sp
     *
     * @return an integer representing src.Tree object's x_sp
     */
    ...
    /**
     * Gets src.Tree object's y_sp
     *
     * @return an integer representing src.Tree object's y_sp
     */
    ...
    /**
     * Compares src.Tree object to another src.Tree object
     * Uses species name as the primary key (alphabetical order); if species name is the same, then tree_id is used
     *
     * @param otherTree other src.Tree object that is used to compare the src.Tree in question
     *
    ...
    @Override
    /**
     * Verify if src.Tree object in question is equal to this src.Tree object by checking its ID and species
     *
     * @param object Object that is casted into a src.Tree object
     *
     * @return a boolean, if src.Tree object in question is equal to this src.Tree
     *
     * @throws IllegalArgumentException if IDs are the same but species are not
     */
    public boolean equals(Object object) {
        //check if object is null if not cast into src.Tree object
    ...
    /**
     * Creates a String object for src.Tree object with its src.Tree ID, Species, Status Borough, and Zipcode
     *
     * @return a String that represents src.Tree object's (more important) information
     */
    public String toString(){
        //add leading 0's to zipcode
        return String.format("%12s: %-12d %12s: %-17s %12s: %-12s %s: %-16s %12s: %-12s",
                "src.Tree ID", this.tree_id, "Species", this.spc_common, "Status", this.status,
