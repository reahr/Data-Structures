...
/**
 * This class allows user to check popularity of different tree names based off a NYC src.Tree Census data set.
 *
 ...
 *
 * Uncomment out "Collections.sort(treeList)" to sort src.TreeList ArrayList (Line 120)
 *
...
public class NYCStreetTrees {
    ...
    public static void main (String[] args) throws FileNotFoundException{
        ...
        if ( args.length < 1 ) {
            ...
            System.err.printf("Usage: java src.NYCStreetTrees [fileName]\n" );
            System.exit(1);
        }
        ...
        //create inventory to add trees from file using src.TreeList class
        ...
        for (int i = 0; fileInput.hasNextLine(); i++) {
            ...
            if (i == 0) {
                ...
                //if headers are incorrect then data will not be parsed accurately into src.Tree--exit program
            ...
            //declare constructor arguments for src.Tree object
            int id, diam, zip;
            ...
            //handle any errors thrown by src.Tree class for invalid arguments
            try {
        ...
        while (!treeNameProvided.equalsIgnoreCase("quit")) {
            ...
            //get all species in src.TreeList inventory matched with user's tree name
